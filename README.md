...
docker build -t devops_beadando:v1 .
...
A projekt kötelezően választható részéhez az OPCIÓ 2 lehetőséget választottam CI - pipeline és Docker registery
A projekt GitHub Actions CI pipeline-t használ, amely automatikusan:
CI pipeline és Docker registery
- pullolja a kódot a GitHub repóból,
- buildeli a Python alkalmazást (`python -m build`),
- buildeli a Docker image-et a projektben található Dockerfile alapján,
- a kész image-et pedig egy free registry-be (Docker Hub) pusholja.

Workflow
A pipeline konfigurációja a következő file-ban található: 
 .github/workflows/ci-docker.yml

Az image lehúzása a registryből: 
docker pull vargapzoltan/devops-beadando:latest

Az image futtatása a registryből: 
docker run -p 8080:5001 vargapzoltan/devops-beadando:latest
